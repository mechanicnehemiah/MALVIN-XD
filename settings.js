...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "MALVIN-XD~0tZAVDpR#2MyoGA1XZaK4ko3JEnG5kgwAaAOgmHKBW3-j70slETM",
// add your Session Id 

PREFIX: process.env.PREFIX || ".",
// add your prifix for bot

BOT_NAME: process.env.BOT_NAME || "✦ᴍᴀv2",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "+254705306694",
// add your bot owner number

OWNER_NAME: process.env.OWNER_NAME || "✦Mech🪀✦",
// add bot owner name

DESCRIPTION: process.env.DESCRIPTION || "> *©✦ɴᴇxᴜs ᴛᴇᴄʜ✦ ɪɴᴄ*",
// add bot owner name    
...
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*🎉👀 Status not Seen by ᴍe🚀🔥*",
...
DEV: process.env.DEV || "+254705306694",
